...
<p>현재  많은  기업들은  그들의  개발, 운영 사이에서  끊임없는  프로세스를  만들어서  조직이  애플리케이션  서비스를  빠르고  안전하게  배포하는  것을  목표로  가지고  있다.<br>
...
<ul>
<li><em>Output “ecs_ids”</em>: 여기서  나오는  instance id를  이용하여  다음  단계에서  진행할  배포된  ECS 인스턴스의 ID들을  얻을  수  있다.</li>
</ul>
